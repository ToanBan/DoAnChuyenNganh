    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          marginTop: "5rem",
          boxShadow:
            "0 20px 25px -5px rgba(75, 85, 99, 0.3), 0 8px 10px -6px rgba(75, 85, 99, 0.3)",
        }}
      >
        <Sidebar backgroundColor="#ffffff">
          ...
          >
            ...
            >
              ...
              <MenuItem
                icon={<PersonIcon />}
                component={<Link href="/admin/students" />}
              >
                Học viên
              </MenuItem>
              <MenuItem
                icon={<SchoolIcon />}
                component={<Link href="/admin/teachers" />}
              >
                Giáo viên
              </MenuItem>
              <MenuItem
                icon={<ChecklistIcon />}
                component={<Link href="/admin/teacher_requests" />}
              >
                Xét duyệt giáo viên
              </MenuItem>
            </SubMenu>
            ...
            {/* Quản lý khóa học */}
            <SubMenu label="Khóa học" icon={<AssignmentIcon />} defaultOpen>
              <MenuItem
                icon={<AssignmentIcon />}
              ...
              <MenuItem
                icon={<AssignmentIcon />}
                component={<Link href="/admin/courses_bought" />}
              >
                Khóa học được mua
              </MenuItem>
              ...
              <MenuItem
                icon={<SchoolIcon />}
                component={<Link href="/admin/courses_by_teacher" />}
              >
                Theo giáo viên
              </MenuItem>
              ...
              <MenuItem
                icon={<VerifiedIcon />}
                component={<Link href="/admin/confirmation_course" />}
              >
                Duyệt Khóa Học
              </MenuItem>
            </SubMenu>
            ...
            <MenuItem
              icon={<ContactsIcon />}
              component={<Link href="/admin/contacts" />}
            >
              Tin Nhắn
            </MenuItem>
          </Menu>
